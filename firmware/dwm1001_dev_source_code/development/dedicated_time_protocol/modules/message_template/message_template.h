...
#define NUM_BYTES_PER_STAMP 5 // Length (bytes) of each timestamp
#define DATA_LEN NUM_STAMPS_PER_NODE * N * NUM_BYTES_PER_STAMP // Length (bytes) of data in standard message
